...
export default function Attendance() {
  ...
  const openApprovalDialog = (attendance) => {
  ...
  const getStatusBadge = (record) => {
    ...
    if (record.is_late) {
      badges.push(<Badge key="late" variant="outline" className="border-orange-500 text-orange-600 dark:text-orange-400">Late</Badge>);
    }
